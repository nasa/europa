...
namespace EUROPA {
  namespace SOLVERS {
    ...
    void UnboundVariableDecisionPoint::handleExecute(){
      ...
      debugMsg("DecisionPoint:handleExecute", "For " << m_flawedVariable->toString() << 
    ...
    void UnboundVariableDecisionPoint::handleUndo(){
      debugMsg("DecisionPoint:handleUndo", "Retracting assignment decision on " << m_flawedVariable->toString());
