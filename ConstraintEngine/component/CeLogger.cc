...
namespace Prototype {
  ...
  void CeLogger::notifyPropagationCompleted(){m_os << "CeLogger:" << "PROPAGATION COMPLETED" << std::endl;}

  void CeLogger::notifyPropagationPreempted(){m_os << "CeLogger:" << "PROPAGATION PREEMPTED" << std::endl;}
