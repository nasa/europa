...
namespace EUROPA {
  ...
  public:
    ...
    IntervalDomain(const std::string& typeName);

    IntervalDomain(edouble lb, edouble ub);

    IntervalDomain(edouble value);

    IntervalDomain(edouble lb, edouble ub, const std::string& typeName);
