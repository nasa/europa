...
/*
 * this has been renamed until SolverModel is fixed
 */
public class PSSolverView extends EuropaInternalFrame implements
		SolverListener {
	...
	public PSSolverView(final SolverModel solver, ConsoleView console) {
		super("Solver");
		this.solver = solver;
		...
		this.goButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					e.printStackTrace();
					JOptionPane.showMessageDialog(PSSolverView.this, e
							.getMessage());
				} finally {
					// Enable buttons
					afterStepping();
