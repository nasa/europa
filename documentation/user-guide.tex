...
%\begin{figure}
%\centering\includegraphics[width=5in]{PlanWorks-tokenNetworkFiltered-ruleInstance-withBattery.eps.gz}
...
top-level directory.
\begin{figure}[htb]
\centering\epsfig{file=Europa2Architecture.eps, width = 4.25in}
\caption{\ET\, Architecture Diagram}
\label{SystemDiagram}
\end{figure}

\begin{figure}[hbt]
\centering\epsfig{file=Europa2PlannerArchitecture.eps, width = 4.25in}
...
\begin{figure}[htb]
\centering\epsfig{file=SpecifyCollaborationDiagram.eps, width = 4.25in}
\caption{Specify Collaboration Diagram}
\label{SpecifyDiagram}
\end{figure}

\begin{figure}[hbt]
\centering\epsfig{file=ActivateCollaborationDiagram.eps, width = 4.25in}
\caption{Activate Collaboration Diagram}
\label{ActivateDiagram}
\end{figure}

\begin{figure}[hbt]
\centering\epsfig{file=MergeCollaborationDiagram.eps, width = 4.25in}
