...
%% TBW: TODO: replace with the timeline view of the last step.

\begin{figure}[h]
\centering\epsfig{file=PlanWorks-timelineView.eps, width = 5in}
...
%% TBW: TODO: Get the resource view with the correct profile!
...
redirected to std::cout.  

%% TBW: include redirect to std::cerr comment
%% TBW: waiting for Debug.cfg spec from Will.
